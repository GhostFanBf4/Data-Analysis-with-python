...
def draw_bar_plot():
    ...
    # Draw bar plot
    fig = df_bar.plot.bar(figsize=(12, 10)).figure
    plt.legend(['January', 'February', 'March', 'April', 'May', 'June', 'July', 'August', 'September', 'October', 'November', 'December'], fontsize=15, title="Months")
    plt.xlabel('Years', fontsize=15)
    plt.ylabel(ylabel='Average Page Views', fontsize=15)
    plt.xticks(size=(15))
    plt.yticks(size=(15))
